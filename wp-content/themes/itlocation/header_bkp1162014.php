                        ...
                        <div class="span3">
							<a href="http://www.itlocator.com/advanced-search/">
								...
								<div class="media-body">
									...
									<p class="font-color-9F9F9F font-size-16">
										<?php _e('Reseller Listings Worldwide', 'twentyten'); ?>
									</p>
								</div>
							</a>
                        </div>
                        <div class="span3">
							<a href="http://www.itlocator.com/member-contributions/">
								<div class="icons-02 pull-left"></div>
								<div class="media-body">
									<h1 class="font-color-fff margin-all-0">
									<?php
										echo get_member_contribution_count();
									?>
									</h1>
									<p class="font-color-9F9F9F font-size-16">
										<?php _e('Member Contributed Articles', 'twentyten'); ?>
									</p>
								</div>
							</a>
                        </div>
