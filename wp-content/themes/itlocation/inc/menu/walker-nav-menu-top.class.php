 ...
 */
class walkerNavMenuTopItLocation extends Walker_Nav_Menu {
    ...
    function start_el(&$output, $item, $depth, $args) {
        ...
        if (($post->post_type == 'member-contributions') || ($post->post_type == 'industry-news-trends')) {
            if ($item->xfn == 'the_latest_itlocation')
                $class_names .= ' active';
        }
        if (($post->post_type == 'forum') || ($post->post_type == 'topic') || ($post->post_type == 'reply')) {
            if ($item->xfn == 'forum_itlocation')
                $class_names .= ' active';
        }
...
/* End of file walker-nav-menu.php */