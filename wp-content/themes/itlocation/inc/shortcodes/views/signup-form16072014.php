...
<div class="" id="jquery-live-validation-signup">
    <form class="" name="mysignup-form" id="mysignup-form" action="" method="post">
        ...
        <?php if ($my_recaptcha_public_key) { ?>
            ...
            <div class="form-group">
                <label class=""><?php _e('Security check', 'bootstrapwp') ?></label>
                <div class="controls" style="margin-left: 128px !important">
                    <?php echo recaptcha_get_html($my_recaptcha_public_key); ?>
