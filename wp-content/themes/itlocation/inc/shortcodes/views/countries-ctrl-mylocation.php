...
<select onchange="return choose_item();" id="<?php echo $id; ?>" name="<?php echo $id; ?>" class="populate placeholder <?php echo $add_class; ?>" style="<?php echo $style; ?>" <?php echo $ctrl_attr; ?> <?php echo ($disabled_combo == 'disabled' )?'disabled="disabled"':''; ?>>
    <option value=""></option>
