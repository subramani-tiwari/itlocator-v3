jQuery(document).ready(function() {
    ...
    jQuery('#comp_description').on("keyup", ".remove", document.getElementById("comp_description"), function(){  
    ...
    jQuery('#go-signup-btn,#signup-modal').live('click', function(){
    ...
    jQuery('.btn_for_modal').live('click', function () {alert("btn_for_modal");
        ...
        jQuery('#go-login-btn').live('click', function() {
   ...
   jQuery('.modal-backdrop.fade.in').hide();  
    ...
    /*jQuery("#signup-modal").find('button').live('click', function () {
   jQuery("#signup-modal").modal('hide');
   jQuery('.modal-backdrop.fade.in').hide();  
   });*/
});
