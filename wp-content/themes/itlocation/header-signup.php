        ...
        <div class="modal-dialog pop-up">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                   <h5 class="noMargin dM"><?php _e('New User', 'twentyten') ?> <a href="#signup-modal" class="" data-dismiss="modal" id="go-signup-btn" data-toggle="modal" role="button"><?php _e('Click here', 'twentyten') ?></a></h5>
