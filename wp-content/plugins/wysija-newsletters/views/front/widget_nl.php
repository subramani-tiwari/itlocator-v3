    ...
    function display($title='',$params,$echo=true,$iframe=false){
        ...
        if(isset($params['form']) && (int)$params['form'] > 0) {
            ...
            if(!empty($form)) {
				...
				$data .='<div class="input-append" style="position:relative;">';
            ...
            if($dataCf){
                ...
                $data.='<p><input type="text" id="'.$form_id_real.'-wysija-to" class="'.$classValidate.' input-xxlarge" value="'.$value_attribute.'" name="wysija[user][email]" /> id="appendedInputButton" placeholder="Enter email be notified ..." style="height:54px; background:#fff; font-size:20px; border:none;"';
                ...
                <button class="btn btn-success btn-large" style="padding-top:20px; padding-bottom:20px;" type="button">Notify Me</button>';
