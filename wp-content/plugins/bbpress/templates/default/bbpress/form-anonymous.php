...
<?php if (bbp_is_anonymous() || ( bbp_is_topic_edit() && bbp_is_topic_anonymous() ) || ( bbp_is_reply_edit() && bbp_is_reply_anonymous() )) : ?>
    ...
    <fieldset class="bbp-form">
        ...
        <p>
            <label class="checkbox"><input type="checkbox" name="bbp_subscriber_itlocation" class="bbpress-content-check-itlocation" value="1" checked="checked" /><?php _e('Subscribe Me to IT Locator Content', 'bbpress'); ?></label>
        </p>
